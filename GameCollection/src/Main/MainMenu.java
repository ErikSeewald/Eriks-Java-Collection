...
public class MainMenu extends JFrame implements MouseListener
{
	...
	public void changeInformation(int game)
	{
		...
		titles[13][3] ="PRESS 1 TO DECREASE THE AMOUNT OF GRAVITY POINTS, 2 TO INCREASE";
		titles[13][4] ="PRESS + TO INCREASE SCREEN SIZE, - TO DECREASE";
		titles[13][5] ="PRESS G TO ACTIVATE GRADIENT RENDERING (WORKS ONLY FOR ONE GRAVITY POINT";
